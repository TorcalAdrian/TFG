...
ax.set_xticklabels(etiquetas_x, rotation=30, ha='right', fontsize=35)



ax.set_ylabel('Tiempo total (segundos)',fontsize=35)
ax.set_title('Comparación de tiempos por dataset y algoritmo',fontsize=35, weight='bold')

ax.legend(title="",
          title_fontsize=28,
          fontsize=28,
          loc='upper center',
          bbox_to_anchor=(0.5, -0.2),  # más abajo que antes
          ncol=2,
          frameon=True)
